app.ViewManager = Backbone.View.extend({
	...
	/*///////////////////////////////// HOME PAGES  ////////////////////////////////////*/
	/*//////////////////////////////////////////////////////////////////////////////////*/
	goto_index_v2a: function(){
		this.show(new app.Index_v2a());
		this.hideNews();
	},
	goto_index_v2b: function(){
		this.show(new app.Index_v2b());
		this.hideNews();
	},
	goto_index_v2c: function(){
		this.show(new app.Index_v2c());
		this.hideNews();
	},
